...
const pointToDollar = '100 points converts to \$1';
const minimumConvert = '(Minimum of 50 points can be converted)';
const redeemGiftCards = 'Redeem Gift Cards';
const availableGiftCards = 'Available Gift Cards';
const requiredPoints = 'Required Points';
